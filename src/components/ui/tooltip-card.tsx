      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-neutral-700 bg-neutral-900 shadow-lg ring-1 shadow-black/20 ring-white/10"
            style={{
              top: position.y,
              left: position.x,
            }}
